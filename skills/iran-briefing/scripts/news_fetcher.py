#!/usr/bin/env python3
"""
News fetcher for Iran/Middle East briefing
...
def get_iran_news():
    """Get Iran/Middle East news"""
    rss_urls = [
        ("https://www.techmeme.com/feed.xml", 5),
    ]
    
    all_news = []
    keywords = ['iran', 'israel', 'gaza', 'hamas', 'hezbollah', 'houthi', 'middle east', 'attack', 'strike']
...
def format_news(news_items):
    ...
    lines = ["Latest Iran/Middle East News\n"]
