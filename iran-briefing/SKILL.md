...
exec:
{
  "command": "python3 /root/.openclaw/workspace/skills/iran-briefing/scripts/send_email.py --to your-email@example.com --subject '伊朗简报 | MM-DD HH:MM' --body '简报PDF已生成，请查看附件。' --attachments /tmp/iran_briefing.pdf"
}
```
...
exec:
{
  "command": "python3 /root/.openclaw/workspace/skills/iran-briefing/scripts/convert_and_send.py /tmp/iran_briefing.html your-email@example.com '伊朗简报 | MM-DD HH:MM'"
}
```
...
**用户请求**: "生成今天的伊朗简报并发送到 your-email@example.com"
